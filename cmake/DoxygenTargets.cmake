...
function(add_doxygen _doxyfile)
	...
	set(EXTRA_INPUT "${CMAKE_SOURCE_DIR}/test ${CMAKE_SOURCE_DIR}/doc  ${CMAKE_SOURCE_DIR}/README.md")
	set(README_PATH "${CMAKE_SOURCE_DIR}/README.md")
	set(IMAGE_PATH "${CMAKE_SOURCE_DIR}/doc/img")
	set(DOXYGEN_THEME "${CMAKE_SOURCE_DIR}/doc/doxygen_theme")
